...
execution \cite{PeytonJones:IFL}. Beyond that, it is unusual
...
performed the same function in 1983 \cite{hughes:thesis}.} combinators. The
...
\cite{HistoryOfHaskell, hughes:thesis}. In order to differentiate between the
