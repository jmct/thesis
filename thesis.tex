...
\documentclass[dottedtoc, headinclude, footinclude=true, a4paper]{scrreprt}
...
\label{part:conclusion}
    ...
    \label{chap:future}
        ...
        \include{Future-Work/Preamble.tex}
    
        \section{Specialising on \underline{\hspace{2cm}}}
        \include{Future-Work/Specialising.tex}
    
        \section{Hybrid Approaches}
        \include{Future-Work/Hybrid.tex}
