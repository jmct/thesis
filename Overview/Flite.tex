...
was always the same \emph{when it terminated}, regardless of evaluation order.
This is an observation of a more general property about rewrite systems known
as the \emph{confluence}. The lambda calculus was proven to be a confluent
...
evaluation terminates \cite{bird2014thinking}.  What does this mean for
